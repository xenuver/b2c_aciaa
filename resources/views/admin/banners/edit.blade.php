                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle', $banner->subtitle) }}" placeholder="Contoh: Koleksi Premium Terkini">
                            @error('subtitle')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Deskripsi Banner (Opsional)</label>
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Contoh: Temukan dress modern dengan bahan premium untuk gaya elegan Anda.">{{ old('description', $banner->description) }}</textarea>
                            @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Gambar Banner (Kosongkan jika tidak diganti)</label>
                            @if($banner->image)
                                <div class="mb-2">
                                    <div style="width: 100%; max-width: 480px; aspect-ratio: 16/6; overflow: hidden; border-radius: 10px; border: 1px solid #ddd;">
                                        <img src="{{ asset('storage/' . $banner->image) }}" id="imagePreview"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link', $banner->link) }}" placeholder="Contoh: /products">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date', $banner->start_date) }}">
                            @error('start_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Tanggal Berakhir (Opsional)</label>
                            <input type="date" name="end_date" class="form-control @error('end_date') is-invalid @enderror" value="{{ old('end_date', $banner->end_date) }}">
