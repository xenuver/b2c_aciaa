                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                @if($rating->product && $rating->product->image)
                                    <img src="{{ url('render-image?path=' . $rating->product->image) }}" alt="" style="width:36px; height:36px; object-fit:cover; border-radius:6px;">
                                @else
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex gap-1 mt-2">
                                    @foreach($rating->images as $img)
                                        <a href="{{ url('render-image?path=' . $img) }}" target="_blank">
                                            <img src="{{ url('render-image?path=' . $img) }}" style="width:40px; height:40px; object-fit:cover; border-radius:6px; border:1px solid #e5e7eb;">
                                        </a>
                                    @endforeach
                                </div>
                                @endif
