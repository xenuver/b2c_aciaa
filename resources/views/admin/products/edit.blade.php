...
<div class="pm-page">
    <div class="pm-topbar">
        <div>
            <h1 class="pm-title">Edit Produk</h1>
            <p class="pm-subtitle">Perbarui informasi produk: <strong>{{ $product->name }}</strong></p>
        </div>
                            ...
                            @if($product->image)
                                <div class="mb-2">
                                    <img src="{{ url('render-image?path=' . $product->image) }}"
                                         class="current-image-preview" alt="Gambar saat ini">
