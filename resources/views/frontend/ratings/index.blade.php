                ...
                <div class="card rating-card p-4 h-100 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <div class="d-flex gap-3 pb-3 border-bottom mb-3 flex-wrap flex-sm-nowrap">
                            <img src="{{ url('render-image?path=' . ($rating->product->image ?? 'default.jpg')) }}" 
                        ...
                        <div class="text-start">
                            ...
                            <div class="d-flex gap-2 mb-3">
                                ...
                                <a href="{{ url('render-image?path=' . $img) }}" target="_blank">
                                    <img src="{{ url('render-image?path=' . $img) }}" alt="Foto ulasan {{ $rating->product->name }}" style="width: 55px; height: 55px; object-fit: cover; border-radius: 8px; border: 1px solid var(--pd-border);">
                                </a>
                                @endforeach
                            </div>
                            @endif
